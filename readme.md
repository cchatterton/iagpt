...
- a GitHub Release tag matching the version, such as `v0.1.4`
- plugin row metadata should keep the AlphaSys author link and GitHub link visible in WordPress
...
4. Create a GitHub Release using a tag such as `v0.1.4`.
